...
public class Math {
    ...
    Math(int type) {
        ...
        final JFrame frame;
        Frame obj = new Frame();
        frame = obj.create_frame(900, 900, "Math");
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (!data.equals("")) {
                            ...
                            try {
                                statement.executeUpdate(
                                        "INSERT INTO `project`.`math` (`post`) VALUES ('" + text.getText()
                                                + "');");
                        ...
                        obj.delete.addActionListener(new ActionListener() {
                            ...
                            public void actionPerformed(ActionEvent e) {
                                ...
                                Math.display.remove(obj.post1);
                                post_content.remove(post_content.indexOf(obj.text1.getText()));
                                try {
                                    statement.executeUpdate("DELETE FROM `project`.`math` WHERE (`post` = '"
                                            + obj.text1.getText() + "');");
                                } catch (SQLException e1) {
                        ...
                        obj.submit.addActionListener(new ActionListener() {
                            ...
                            public void actionPerformed(ActionEvent e) {
                                ...
                                try {
                                    statement.executeUpdate(
                                            "UPDATE `project`.`math` SET `post` = '" + obj.text1.getText()
                                                    + "' WHERE (`post` = '" + obj.x + "');");
                                } catch (SQLException e1) {
                                    // TODO Auto-generated catch block
    ...
    public static void table() {
        try {
            ...
            post_result = statement.executeQuery("SELECT * FROM project.math;");
